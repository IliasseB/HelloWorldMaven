pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL = 'https://github.com/IliasseB/HelloWorldMaven'
        // TRÈS IMPORTANT : Remplacez cette valeur par l'ID exact de votre credential Jenkins
        CREDENTIALS_ID = 'github-token' // <--- REMPLACER PAR VOTRE VRAI ID TROUVÉ DANS JENKINS
        GIT_EMAIL = 'iliasse.bellouch@edu.univ-paris13.fr'
        GIT_NAME = 'IliasseB'
